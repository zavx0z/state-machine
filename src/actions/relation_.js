...
/** @typedef {import("https://cdn.jsdelivr.net/npm/@metafor/machine@0.0.9/+esm").StateNodeDefinition<any, any, any> & { transition: string[]}} Machine */
...
export function representation(Machine, MetaData, MachineRelation) {
   ...
   * @param {Machine | import("https://cdn.jsdelivr.net/npm/@metafor/machine@0.0.9/+esm").AnyStateNodeDefinition} stateNode - The state machine or state node.
